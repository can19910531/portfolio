...
| 時間 | 作品 | 說明 | 技術 |
|---|---|---|---|
| 202608 | [📈 stock-morning-brief](stock-morning-brief/) | AI 股票晨報機器人：每天自動網搜市場重點、技術面健檢自選股、產 K線+MACD 圖，推播到 Telegram。**用 AI 訪談完成安裝**——clone 後叫你的 AI 讀任務書，逐題問完自動設定好。 | Python · yfinance · mplfinance · Telegram Bot API · AI agent 任務書 |
